...
public class AdminDao extends BaseHibernateDAO {
	...
	public Admin findById(java.lang.Integer id) {
		...
		try {
			Admin instance = (Admin) getSession().get("com.model.Admin", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Admin instance) {
		...
		try {
			List results = getSession().createCriteria("com.model.Admin")
	...
	public List findByAdminUsername(Object adminUsername) {
		return findByProperty(ADMIN_USERNAME, adminUsername);
	}
	...
	public boolean modify(String username, String password, String name) {
